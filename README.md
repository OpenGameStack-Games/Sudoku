...
- **Statistics Screen (`game/scenes/statistics_screen.tscn`, `game/scripts/statistics_screen.gd`):** Dedicated UI screen styled in 1930s monochrome presentation with enlarged, high-readability difficulty cards and typography displaying player performance metrics (games started, games won, best times, and average times) categorized by Very Easy, Easy, Medium, Hard, and Very Hard difficulties with smooth navigation back to the main menu.
