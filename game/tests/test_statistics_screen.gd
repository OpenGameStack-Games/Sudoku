...
func test_statistics_screen_styling_applied() -> void:
	...
	var easy_card = scene.get_node("MarginContainer/VBoxContainer/ScrollContainer/CardsContainer/EasyCard")
	...
	var diff_lbl = scene.get_node("MarginContainer/VBoxContainer/ScrollContainer/CardsContainer/EasyCard/VBox/DifficultyLabel") as Label
	assert_eq(diff_lbl.get_theme_font_size("font_size"), 48, "DifficultyLabel font size should be 48")
	
	var started_val = scene.get_node("MarginContainer/VBoxContainer/ScrollContainer/CardsContainer/EasyCard/VBox/GridContainer/StartedValue") as Label
