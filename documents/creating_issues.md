...
All issues filed in Sudoku must follow this standardized layout. When creating an issue on GitHub, use one of the predefined templates in `.github/ISSUE_TEMPLATE/`:
...
See [Issue #21: UI - Update Absent Letter Color to Flat Red Across Tiles, Keyboard, and Share Grid](https://github.com/OpenGameStack-Games/Sudoku/issues/21) for a live example of an issue meeting this standard.
